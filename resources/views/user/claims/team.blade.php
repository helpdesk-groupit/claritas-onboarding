                    ...
                    <div class="collapse {{ $moOpen ? 'show' : '' }}" id="tm-{{ $yr }}-{{ $mo }}">
                        <div class="acc-body month-body">
                            ...
                            <div class="acc-group emp-grp" data-default-open="0">
                                <button type="button" class="acc-head emp-head" data-bs-toggle="collapse" data-bs-target="#te-{{ $yr }}-{{ $mo }}-{{ $empId }}" aria-expanded="false">
                                    <span class="acc-head-left">
                                ...
                                <div class="collapse" id="te-{{ $yr }}-{{ $mo }}-{{ $empId }}">

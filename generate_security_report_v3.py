...
doc.add_paragraph(
    'This v3 report re-assesses the Claritas Onboarding HR Management System against OWASP Top 10 (2021), '
...
add_heading_with_color('6.2 Open Findings (v3)', 2)
...
owasp_scores = [
    ('A01', 'Broken Access Control', 'RBAC + nav-context-gated controls', 'PASS'),
    ('A02', 'Cryptographic Failures', 'HTTPS+HSTS, encrypted backups, EXIF strip', 'PASS'),
    ('A03', 'Injection', 'All queries parameterised', 'PASS'),
    ('A04', 'Insecure Design', 'ThreatDetector + alerting + magic-bytes', 'PASS'),
...
# SAVE
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Security_Checklist_Report_v3.1.docx')

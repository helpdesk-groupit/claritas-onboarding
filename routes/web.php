...
Route::delete('/hr/employees/{employee}/orientation',[EmployeeController::class, 'orientationDelete'])->name('employees.orientation.delete');
    ...
    Route::post('/my/claims/new',                       [ExpenseClaimController::class, 'createClaim'])->name('user.claims.create');
    Route::get('/my/claim-reports',                     [ExpenseClaimController::class, 'reports'])->name('user.claims.reports');
    ...
    Route::post('/my/claims/{claim}/correct',           [ExpenseClaimController::class, 'makeCorrection'])->name('user.claims.correct');
    ...
    Route::post('/my/team-claims/{claim}/release',      [ExpenseClaimController::class, 'releaseRejection'])->name('user.claims.team.release');
